                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                // autogroupaqs3CGj (NgXHgiNtXZ3Mzy8xijaqS3)
                                padding: EdgeInsets.fromLTRB(0.44 * fem,
                                    0 * fem, 0.44 * fem, 19.12 * fem),
                                width: double.infinity,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Container(
                                      // titleWoD (129:16)
                                      margin: EdgeInsets.fromLTRB(6.44 * fem,
                                          0 * fem, 0 * fem, 33 * fem),
                                      constraints: BoxConstraints(
                                        maxWidth: 148 * fem,
                                      ),
